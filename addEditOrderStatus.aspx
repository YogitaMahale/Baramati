<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="addEditOrderStatus.aspx.cs" Inherits="addEditOrderStatus" %>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  <div class="col-xs-6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" ControlToValidate="txtorderType" ValidationGroup="gg"  runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>   
                       
                    </div>
                        </div>
                        <div class="form-group row">
                        <div class="col-xs-6"> 
                        <label for="exampleInputEmail1"> Notification Message<span style="color:red">*</span></label>
                        <asp:TextBox ID="txtNotificationmsg" CssClass="form-control" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtNotificationmsg" ValidationGroup="gg"  runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>   
