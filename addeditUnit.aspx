<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="addeditUnit.aspx.cs" Inherits="addeditUnit" %>
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Unit Name </label>
                         <asp:TextBox ID="txtunitname" class="form-control" runat="server"></asp:TextBox>
                          <asp:RequiredFieldValidator ID="RFVtxtCategoryName" runat="server" Display="Dynamic" ControlToValidate="txtunitname" CssClass="error" ErrorMessage="Required Field" ValidationGroup="c1"></asp:RequiredFieldValidator>
                    </div>
