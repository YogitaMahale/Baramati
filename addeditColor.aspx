<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="addeditColor.aspx.cs" Inherits="addeditColor" %>
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Color Name </label>
                         <asp:TextBox ID="txtColorName" class="form-control" runat="server"></asp:TextBox>
                          <asp:RequiredFieldValidator ID="RFVtxtCategoryName" runat="server" Display="Dynamic" ControlToValidate="txtColorName" CssClass="error" ErrorMessage="Required Field" ValidationGroup="c1"></asp:RequiredFieldValidator>
                    </div>
