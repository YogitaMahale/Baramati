<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="manageRawMaterial.aspx.cs" Inherits="manageRawMaterial" %>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div style="text-align:right;">
                                <asp:Button ID="btnNewCategoty" runat="server" Text="Add New Raw Material" class="btn btn-Normal btn-primary" OnClick="btnNewCategoty_Click" Width="150" />
                            </div>
                            <br />
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <asp:Repeater ID="repRawMaterial" runat="server" OnItemDataBound="repCategory_ItemDataBound">
                                        <ItemTemplate>
                                            <tr>
