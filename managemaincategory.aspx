<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="managemaincategory.aspx.cs" Inherits="managemaincategory" %>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div style="text-align:right;">
                                <asp:Button ID="btnNewCategoty" runat="server" Text="New Main Category" class="btn btn-Normal btn-primary" OnClick="btnNewCategoty_Click" Width="150" />
                            </div>
                            <br />
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    ...
                                                    <asp:Label ID="lblProductCount" runat="server" Visible="false" Text='<%# Eval("categorycount") %>'></asp:Label>
